...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="/xinlida/Public/Admin/assets/css/ace-rtl.min.css" />
		<link rel="stylesheet" href="/xinlida/Public/Admin/assets/css/ace-skins.min.css" />
		...
		<![endif]-->
		<script src="/xinlida/Public/Admin/assets/js/ace-extra.min.js"></script>
		<!--[if lt IE 9]>
		<script src="/xinlida/Public/Admin/assets/js/html5shiv.js"></script>
		<script src="/xinlida/Public/Admin/assets/js/respond.min.js"></script>
		<![endif]-->
        <!--[if !IE]> -->
		...
		<!--[if lte IE 8]>
		  <script src="/xinlida/Public/Admin/assets/js/excanvas.min.js"></script>
		<![endif]-->
        ...
        <script src="/xinlida/Public/Admin/js/jquery.nicescroll.js" type="text/javascript"></script>
...
<script type="text/javascript">
					...
					<ul class="nav nav-list" id="nav_list">
                     ...
                     <li><a href="#" class="dropdown-toggle"><i class="icon-desktop"></i><span class="menu-text"> 网站配置 </span><b class="arrow icon-angle-down"></b></a>
					   <ul class="submenu">
						 ...
						 <li class="home"><a  href="javascript:void(0)" name="<?php echo U('Admin/Index/gsjj');?>" title="公司简介"  class="iframeurl"><i class="icon-double-angle-right"></i>公司简介</a></li>
						 <li class="home"><a href="javascript:void(0)" name="<?php echo U('Admin/Index/xhzy');?>" title="现货资源"  class="iframeurl"><i class="icon-double-angle-right"></i>现货资源</a></li>
						 <li class="home"><a href="javascript:void(0)" name="<?php echo U('Admin/Index/kczs');?>" title="库存展示"  class="iframeurl"><i class="icon-double-angle-right"></i>库存展示</a></li>
						 <li class="home"><a href="javascript:void(0)" name="<?php echo U('Admin/Index/picture');?>" title="图片配置"  class="iframeurl"><i class="icon-double-angle-right"></i>图片配置</a></li>

						</ul>
					</li>
					<li>
					<a href="#" class="dropdown-toggle"><i class="icon-picture "></i><span class="menu-text"> 新闻管理 </span><b class="arrow icon-angle-down"></b></a>
						<ul class="submenu">
						<li class="home"><a href="javascript:void(0)" name="<?php echo U('Admin/Index/showNews');?>" title="添加新闻" class="iframeurl"><i class="icon-double-angle-right"></i>添加新闻</a></li>
					...
					<li>
					<a href="#" class="dropdown-toggle"><i class="icon-list"></i><span class="menu-text"> 产品管理 </span><b class="arrow icon-angle-down"></b></a>
                    <ul class="submenu">
                    <li class="home"><a href="javascript:void(0)" name="<?php echo U('Admin/Index/fenlei');?>" title="添加产品分类"  class="iframeurl"><i class="icon-double-angle-right"></i>添加产品分类</a></li>
					<li class="home"><a href="javascript:void(0)" name="<?php echo U('Admin/Index/fenleiList');?>" title="交易订单（图）"  class="iframeurl"><i class="icon-double-angle-right"></i>产品分类列表</a></li>
                    <li class="home"><a href="javascript:void(0)" name="<?php echo U('Admin/Index/product');?>" title="添加产品"  class="iframeurl"><i class="icon-double-angle-right"></i>添加产品</a></li>
                    <li class="home"><a href="javascript:void(0)" name="<?php echo U('Admin/Index/productList');?>" title="产品列表"  class="iframeurl"><i class="icon-double-angle-right"></i>产品列表</a></li>
                   </ul>
				  </li>
                   <li>
				   <a href="#" class="dropdown-toggle"><i class="icon-credit-card"></i><span class="menu-text"> 友情链接 </span><b class="arrow icon-angle-down"></b></a>
				     <ul class="submenu">
