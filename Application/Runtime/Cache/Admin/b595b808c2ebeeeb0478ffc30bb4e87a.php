...
<head>
    ...
    <link rel="stylesheet" href="/xinlida/Public/plugins/layui/css/layui.css" media="all">
    <link rel="stylesheet" type="text/css" href="http://www.jq22.com/jquery/font-awesome.4.6.0.css">
    <link rel="stylesheet" href="/xinlida/Public/build/css/app.css" media="all">
</head>
        ...
        layui.config({
            ...
            $('#pay').on('click', function() {
                layer.open({
                    title: false,
                    type: 1,
                    content: '<img src="/xinlida/Public/build/images/pay.png" />',
                    area: ['500px', '250px'],
                    shadeClose: true
                });
            });
