    ...
    <div class="stystems_style">
        <div class="tabbable">
            ...
            <div class="tab-content">
                <form action="<?php echo U('Admin/Index/exitPic');?>" enctype="multipart/form-data" method="post">
                    <input type="hidden" name="id" value="<?php echo ($data["id"]); ?>">
                <div id="home" class="tab-pane active">
                    <div class="form-group"><label class="col-sm-1 control-label no-padding-right" for="form-field-1"><i>*</i>图片： </label>
                        <div class="col-sm-9"><input type="file" id="website-title" placeholder="分类名称"   name="url" class="col-xs-10" ></div>
                    </div>
                    <div>
                        <img src="/xinlida/Public/Uploads/<?php echo ($vo["url"]); ?>" alt="">
                    </div>
