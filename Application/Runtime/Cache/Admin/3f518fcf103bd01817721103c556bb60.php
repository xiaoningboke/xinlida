...
<div class="margin clearfix">
    <div class="article_style">
        <div class="add_content" id="form-article-add">
            <form action="<?php echo U('Admin/Index/exitNews');?>" method="post">
                <input type="hidden" name="id" value="<?php echo ($data["id"]); ?>">
                <input type="hidden" name="classify" value="1">
            <ul>
                <li class="clearfix Mandatory">
                    <label class="label_name"><i>*</i>新闻标题</label><span class="formControls col-10"><input name="title" type="text" id="form-field-1" class="col-xs-10 col-sm-5 " value="<?php echo ($data["title"]); ?>"></span>
                </li>
                <li class="clearfix"><label class="label_name"><i>*</i>所属分类</label>
                    <span class="formControls col-4">
                        <select class="form-control" id="form-field-select-1" name="fenlei">
                            ...
                            <?php if($data["fenlei"] == 0 ): ?><option value="0" selected="selected">热点资讯</option>
                                <option value="1">行情关注</option>
                                <option value="2">知识汇编</option>
                            <?php elseif($data["fenlei"] == 1): ?>
                                <option value="0">热点资讯</option>
                                <option value="1" selected="selected">行情关注</option>
                                 <option value="2">知识汇编</option>
                            <?php elseif($data["fenlei"] == 2): ?>
                                <option value="0">热点资讯</option>
                                <option value="1">行情关注</option>
                                <option value="2" selected="selected">知识汇编</option>
                            <?php else: endif; ?>
                ...
                <li class="clearfix"><label class="label_name">时间</label>
                    ...
                    <input type="hidden" name="time" id="time" value="<?php echo ($data["time"]); ?>">
                </li>
