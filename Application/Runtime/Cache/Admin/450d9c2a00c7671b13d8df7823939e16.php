    ...
    <div class="stystems_style">
        <div class="tabbable">
            ...
            <div class="tab-content">
                <form action="<?php echo U('Admin/Index/addFenlei');?>" method="post">
                <div id="home" class="tab-pane active">
                    <div class="form-group"><label class="col-sm-1 control-label no-padding-right" for="form-field-1"><i>*</i>分类名称： </label>
                        <div class="col-sm-9"><input type="text" id="website-title" placeholder="分类名称"  name="name" class="col-xs-10" ></div>
                    </div>
