        ...
        <div class="article_sort_list">
            <table class="table table-striped table-bordered table-hover" id="sample-table">
                ...
                <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                        ...
                        <td>
                            <?php if($vo["fenlei"] == 0 ): ?>热点资讯
                            <?php elseif($vo["fenlei"] == 1): ?>行情关注
                            <?php elseif($vo["fenlei"] == 2): ?>知识汇编
                            <?php else: endif; ?>
                        </td>
                        <td class="td-manage">
                            <a href="#">查看</a>
                            <a href="<?php echo U('Admin/Index/findNews',array('id'=>$vo['id']));?>">编辑</a>
                            <a href="<?php echo U('Admin/Index/delNews',array('id'=>$vo['id']));?>">删除</a>
                        </td>
